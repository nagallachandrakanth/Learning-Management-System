...
public class RegistrationEmail {
	...
	@Bean
	public RegistrationEmail beanCreation() {
		return new RegistrationEmail();
	}
	public void sendingEmail (String from,String to) {
		...
		try {
			...
			message.setSubject("mail checking");
			System.out.println("sending mail");
			
			MimeBodyPart mimeTextPart = new MimeBodyPart();
			mimeTextPart.setText("This mail is regarding to check whether the mail is send or not by using java code ");
